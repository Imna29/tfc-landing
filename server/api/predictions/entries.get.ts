 ...
 * anybody made.
 *
 * This is not the Entry history. That is `/api/predictions/history`, which My
 * Predictions reads: it goes back through every Season and grades each
 * Prediction of a chain. This is the Entries a fan can still do something
 * about, beside the card they were committed on.
 */
