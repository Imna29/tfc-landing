...
<template>
  <section class="relative min-h-[921px] flex items-center overflow-hidden">
    ...
    <div class="container mx-auto px-6 md:px-20 relative z-20">
      <div class="max-w-4xl">
        <div
          class="inline-block bg-primary-container text-white px-4 py-1 mb-6 font-bold uppercase tracking-tighter"
        >
        ...
        >
          Experience the raw intensity of the Caucasus' premier fighting organization. Elite
          strikers, world-class grapplers, one octagon.
        </p>
        <div class="flex flex-col sm:flex-row gap-4">
          <button
            class="bg-primary-container text-white px-10 py-5 font-black uppercase text-lg flex items-center justify-center gap-3 group"
          >
            Buy Tickets
            <Icon
          ...
          <button
            class="border-2 border-outline-variant/30 text-white px-10 py-5 font-black uppercase text-lg flex items-center justify-center gap-3 backdrop-blur-sm hover:bg-white/5 transition-colors"
          >
            Watch Highlights
