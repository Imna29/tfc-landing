 ...
 * this list says is which of them a fan is offered on the card *today*: the
 * round is #43's, arriving with the copy and the end-to-end coverage that go
 * with a Question whose answers have just started naming a fighter
 * (ADR-0015).
 *
