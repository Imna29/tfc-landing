 ...
 * this list says is which of them a fan is offered on the card *today*: #33
 * adds the method and #34 the round, one at a time, each arriving with the
 * copy and the end-to-end coverage that go with a Question standing on its
 * own.
 *
